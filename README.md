        ...
        <div align='center'>
         ...
         <li>레퍼런스: <em>"출처: TERO KERRAS, 「TRAINING GENERATIVE ADVERSARIAL NETWORKS WITH LIMITED DATA」, 2020"</em></li>
            ...
            <table class="sadtalker-table">
                <tr>
                    <td width="300"><img src="https://github.com/tlsdmswn01/StyleGAN2-Toonify-TalkingHead/assets/121289391/b22a9188-b0f0-44ba-8d4e-d8a32810a0ae" height="300" alt="SSLRV1_full.png"></td>
                    <td>
                        <ol>
                            <li>모델 선정 이유</li>
                            <ul>
